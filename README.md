# nvim-treesitter-queries-scss

[![Validate Queries](https://github.com/neovim-treesitter/nvim-treesitter-queries-scss/actions/workflows/validate.yml/badge.svg)](https://github.com/neovim-treesitter/nvim-treesitter-queries-scss/actions/workflows/validate.yml)

Neovim tree-sitter queries for **scss**, part of the
...
```jsonc
{
  ...
  "url": "https://github.com/tree-sitter/tree-sitter-scss",
...
- [ ] Changes are scoped to `scss` — do not include files for other languages
